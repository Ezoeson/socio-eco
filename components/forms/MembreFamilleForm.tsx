  ...
  return (
    <div className='p-4 border rounded-lg space-y-4'>
      ...
      <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4'>
        ...
        <div className='space-y-2'>
          <Label htmlFor={`village-${membre.id}`}>Village d&apos;origine</Label>
          <Input
        ...
        <div className='space-y-2'>
          <Label htmlFor={`annee-${membre.id}`}>Année d&apos;arrivée</Label>
          <Input
            id={`annee-${membre.id}`}
            type='number'
        ...
        <div className='flex items-center space-x-2'>
          ...
          />
          <Label htmlFor={`ecole-${membre.id}`}>Fréquentation scolaire</Label>
        </div>
      </div>
    </div>
  );
